...
CASES = [
    ...
    (dict(artist="Kolsch", title="Grey (Tale Of Us Remix)", mix="Tale Of Us Remix",
          duration_ms=410000),
     dict(artist="Kolsch", title="Grey", mix="Original Mix",
          remixers=[], length_ms=400000),
     False, "wants a remix, offered the original"),
    (dict(artist="Kolsch", title="Grey (Tale Of Us Remix)", mix="Tale Of Us Remix",
          duration_ms=410000),
     dict(artist="Kolsch", title="Grey", mix="Mano Le Tough Remix",
          remixers=["Mano Le Tough"], length_ms=420000),
     False, "wants a remix, offered a different remix"),
    (dict(artist="Bicep", title="Glue", mix="", duration_ms=330000),
